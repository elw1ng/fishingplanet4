        ...
        while True:
            while not losted:
                ...
                while not losted:
                    ...
                    if Prediction[0].probs.top1 >= 3 and ((Prediction[0].probs.top1conf> 0.25) or (Prediction[0].probs.top1conf + Prediction[0].probs.top5conf[1]> 0.35 and Prediction[0].probs.top5[1]>=3)):
                        print("PULL")
                        self.lkmpress()
                        break
